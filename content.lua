...
print("zone.Kalimdor: "..zone.Kalimdor)
	...
	-- Kurenai 978
		...
		FIZ_AddMob(978, 4, 8, "Boulderfist ogres", 10, "3518")
		FIZ_AddMob(978, 4, 8, "Kil'sorrow Deathsworn, Cultist & Spellbinder", 10, "3518")
		FIZ_AddMob(978, 4, 8, "Murkblood Scavenger", 2, "3518")
		FIZ_AddMob(978, 4, 8, "Murkblood ", 10, "3518")
		FIZ_AddMob(978, 4, 8, "Warmaul non-elite", 10, "3518")
	-- Northrend (WotLK)
	...
	-- The Mag'har 941
		...
		FIZ_AddMob(941, 4, 8, "Boulderfist ogres", 10, "3518")
		FIZ_AddMob(941, 4, 8, "Kil'sorrow Deathsworn, Cultist & Spellbinder", 10, "3518")
		FIZ_AddMob(941, 4, 8, "Murkblood Scavenger", 2, "3518")
		FIZ_AddMob(941, 4, 8, "Murkblood ", 10, "3518")
		FIZ_AddMob(941, 4, 8, "Warmaul non-elite", 10, "3518")
	-- Tranquillien 922
	...
	-- Steamwheedle Cartel
	-- Booty Bay 21
		FIZ_AddMob(21, 1, 7, 11, 5, "440")

		FIZ_AddMob(21, 1, 8, 12, 2.5, "440")
		FIZ_AddMob(21, 1, 8, 13, 2.5, "440")
		FIZ_AddMob(21, 1, 7, 14, 5, "33")
		FIZ_AddMob(21, 1, 7, 15, 12.5, "33")
		FIZ_AddMob(21, 1, 8, 15, 7.5, "33")
		FIZ_AddMob(21, 1, 8, 17, 7.5, "440")
		FIZ_AddMob(21, 1, 7, "Cap'n Garvey & Alicia Cuthbert", 5, "17")
		FIZ_AddQuest(21, 1, 3, 9259, 500, {[4306] = 1, [2604] = 1})
	-- Everlook 577
		FIZ_AddMob(577, 1, 7, 11, 2.5, "440")

		FIZ_AddMob(577, 1, 7, 12, 2.5, "440")
		FIZ_AddMob(577, 1, 8, 13, 5, "440")
		FIZ_AddMob(577, 1, 7, 14, 2.5, "33")
		FIZ_AddMob(577, 1, 8, 15, 7.5, "33")
		FIZ_AddMob(577, 1, 8, 15, 7.5, "33")
		FIZ_AddMob(577, 1, 7, 17, 12.5, "440")
		FIZ_AddMob(577, 1, 8, "Cap'n Garvey & Alicia Cuthbert", 12.5, "17")
		FIZ_AddQuest(577, 1, 3, 9266, 500, {[14047] = 1, [3857] = 1})
	-- Gadgetzan 369
		FIZ_AddMob(369, 1, 8, 11, 2.5, "440")

		FIZ_AddMob(369, 1, 8, 12, 2.5, "440")
		FIZ_AddMob(369, 1, 7, 13, 5, "440")
		FIZ_AddMob(369, 1, 7, 14, 2.5, "33")
		FIZ_AddMob(369, 1, 8, 15, 7.5, "33")
		FIZ_AddMob(369, 1, 7, 15, 12.5, "33")
		FIZ_AddMob(369, 1, 8, 17, 12.5, "440")
		FIZ_AddMob(369, 1, 7, "Cap'n Garvey & Alicia Cuthbert", 25, "17")
		FIZ_AddQuest(369, 1, 3, 9268, 500, {[4338] = 1, [3466] = 1})
	-- Ratchet 470
		FIZ_AddMob(470, 1, 8, 11, 2.5, "440")

		FIZ_AddMob(470, 1, 8, 12, 2.5, "440")
		FIZ_AddMob(470, 1, 8, 13, 2.5, "440")
		FIZ_AddMob(470, 1, 7, 14, 2.5, "33")
	...
	-- Bloodsail Buccaneers 87
		...
		FIZ_AddMob(87, 1, 7, "Some Booty Bay Named", 5, "19946")
		FIZ_AddMob(87, 1, 7, "Most Booty Bay Named", 1, "19946")
		FIZ_AddMob(87, 1, 7, "Most Faldir's Cove Named", 5)
		FIZ_AddMob(87, 1, 7, "Baron Revilgaz, Grizzlowe, &Wharfmaster Lozgil", 25, "19946")
		FIZ_AddMob(87, 1, 7, "Viznik & Rickle Goldgrubber (bankers)", 25, "19946")
	-- Classic world
	-- Argent Dawn 529
	...
	-- Ravenholdt 349
		...
		FIZ_AddMob(349, 4, 6, "All Syndicate members", 5, "267")
	-- Syndicate 70
		FIZ_AddMob(70, 1, 4, "Myrokos Silentform", 25, "267")
		FIZ_AddMob(70, 1, 4, "Winstone Wolfe", 5, "267")
		FIZ_AddMob(70, 1, 4, "Lord Jorach Ravenholdt", 5, "267")
		FIZ_AddMob(70, 1, 4, "Fahrad", 5, "267")
		FIZ_AddMob(70, 1, 4, "Zan Shivsproket", 5, "267")
		FIZ_AddMob(70, 1, 4, "Smudge Thunderwood", 5, "267")
		FIZ_AddMob(70, 1, 4, "Simone Cantrell", 5, "267")
		FIZ_AddMob(70, 1, 4, "Master Kang", 5, "267")
		FIZ_AddMob(70, 1, 4, "Carlo Aurelius", 5, "267")
		FIZ_AddMob(70, 1, 4, "Ravenholdt Assassin", 5, "267")
		FIZ_AddMob(70, 1, 4, "Ravenholdt Guard", 5, "267")
	...
	-- Timbermaw Hold 576
		...
		FIZ_AddMob(576, 2, 6, "Deadwood Avenger, Den Watcher, Shaman, Gardener, Pathfinder & Warrior", 20, "361")
		FIZ_AddMob(576, 2, 6, "Winterfell Runner, Den Watcher, Shaman, Pathfinder, Totemic,  & Ursa", 20, "618")
		FIZ_AddMob(576, 2, 8, "Chieftain Bloodmaw", 60, "361")
		FIZ_AddMob(576, 2, 8, "Overlord Ror", 60, "361")
		FIZ_AddMob(576, 2, 8, "Ragepaw (Rare)", 50, "361")
		FIZ_AddMob(576, 2, 8, "Grizzle Snowpaw (Rare)", 50, "618")
		FIZ_AddMob(576, 2, 8, "High Chief Winterfall", 50, "618")
	...
	-- Brood of Nozdormu 910
		...
		FIZ_AddMob(910, 1, 4, "Anubisath Defender", 100, "766")
		FIZ_AddMob(910, 1, 4, "Anubisath Sentinel", 100, "766")
		FIZ_AddMob(910, 1, 4, "Obsidian Eradicator", 100, "766")
		FIZ_AddMob(910, 1, 4, "Qiraj Lasher", 100, "766")
		FIZ_AddMob(910, 1, 4, "Vekniss Hive Crawler", 100, "766")
		FIZ_AddMob(910, 1, 4, "Vekniss Soldier", 100, "766")
		FIZ_AddMob(910, 1, 4, "Vekniss Stinger", 100, "766")
		FIZ_AddMob(910, 1, 4, "Vekniss Warrior", 100, "766")
		FIZ_AddMob(910, 1, 4, "Vekniss Wasp", 100, "766")
		FIZ_AddMob(910, 1, 8, "Most Bosses", 50)
		FIZ_AddMob(910, 1, 8, "Ossirian", 100, "717")
		FIZ_AddMob(910, 1, 8, "Twin Emperors", 200, "766")
		FIZ_AddMob(910, 1, 8, "Cthun", 2500, "766")
	...
	-- Hydraxian Waterlords 749
		FIZ_AddMob(749, 4, 5, "Desert Rumbler, Dust Stormer", 5, "261")
		FIZ_AddMob(749, 4, 5, "Greater Obsidian Elemental", 5, "29")
		FIZ_AddMob(749, 4, 6, "Lord Incendius", 15, "704")
		FIZ_AddMob(749, 4, 6, "Huricanian (Rare)", 25, "261")
		FIZ_AddMob(749, 4, 6, "Pyroguard Emberseer", 50, "721")
		FIZ_AddMob(749, 4, 6, "Molten Core Trash", 20, "696")
		FIZ_AddMob(749, 4, 6, "Molten Destroyer & Lava Pack", 40, "696")
	...
	-- The Scale of the Sands 990
		...
		FIZ_AddMob(990, 4, 8, 0, 12, "775")
		FIZ_AddMob(990, 4, 8, "Frost Wyrm", 60, "775")
		FIZ_AddMob(990, 4, 8, 0, 375, "775")
		FIZ_AddMob(990, 4, 8, "Archimonde", 1500, "775")
	-- The Violet Eye 967
		FIZ_AddInstance(967, 4, 8, 734, 6000, FALSE)
		FIZ_AddMob(967, 4, 8, 0, 250, "799")
		FIZ_AddMob(967, 4, 8, 0, 15, "799")
	-- Outlands (Burning Crusade)
	-- Cenarion Expedition 942
		...
		FIZ_AddMob(942, 4, 4, "Steam Pump Overseer", 1, "467")
		FIZ_AddMob(942, 4, 4, "Wrekt Slave", 2.5, "467")
		FIZ_AddMob(942, 4, 4, "Dreghood Drudge", 2.5, "467")
		FIZ_AddMob(942, 4, 4, "Bloodscale Overseer", 5, "467")
		FIZ_AddMob(942, 4, 4, "Bloodscale Wavecaller", 5, "467")
		FIZ_AddMob(942, 4, 4, "Darkcrest Sorceress", 5, "467")
		FIZ_AddMob(942, 4, 4, "Darkcrest Slaver", 5, "467")
		FIZ_AddMob(942, 4, 4, "Terrorclaw", 7, "467")
	-- Keepers of Time 989
	...
	-- Sha'tari Skyguard 1031
		...
		FIZ_AddMob(1031, 4, 6, "Skettis Kaliri", 2.5, "478")
		FIZ_AddMob(1031, 4, 8, "Skettis, Talonpriests, Time-Lost Skettis, Monstrous Kaliri", 10, "478")
		FIZ_AddMob(1031, 4, 8, "Talonsworn Forest-Rager", 30, "478")
		FIZ_AddMob(1031, 4, 8, "Akkarai, Karrog, Gezzarak, Vakkiz", 100, "478")
		FIZ_AddMob(1031, 4, 8, "Terokk", 500, "478")
	-- Sporeggar 970
	...
	------ (courtesy of Henrik H AKA Szereka <Vendredi> At HELLSCREAM-EU)
		FIZ_AddMob(1204, 4, 6, "Druid of the Flame", 5, "800")
		FIZ_AddMob(1204, 4, 6, "Cinderweb Spider", 5, "800")
		FIZ_AddMob(1204, 4, 6, "Fire Scorpion", 5, "800")
		FIZ_AddMob(1204, 4, 6, "Cinderweb Spinner", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Cinderweb Drone", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Fire Turtle Hatchling", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Beast Handler", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Cauterizer", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Forward Guard", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Hound Master", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Pathfinder", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Sentinel", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Taskmaster", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Trainee", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Giant Fire Scorpion", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Hell Hound", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Molten Surger", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Patriarch Fire Turtle", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Unbound Pyrelord", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Unbound Smoldering Elemental", 15, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Animator", 16, "800")
		FIZ_AddMob(1204, 4, 6, "Flamewalker Centurion", 16, "800")
		FIZ_AddMob(1204, 4, 6, "Harbringer of Flame", 16, "800")
		FIZ_AddMob(1204, 4, 6, "Matriarch Fire Turtle", 16, "800")
		FIZ_AddMob(1204, 4, 6, "Unbound Blazing Elemental", 16, "800")
	---- stop at friendly
		FIZ_AddMob(1204, 4, 7, "Ancient Core Hound", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Blazing Monstrosity", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Flame Archon", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Flamewalker Overseer", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Flamewalker Subjugator", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Kar the Everburning", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Molten Erupter", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Molten Flamefather", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Molten Lord", 50, "800")
		FIZ_AddMob(1204, 4, 7, "Unstable Magma", 50, "800")
	---- Stop at Honored
		FIZ_AddMob(1204, 4, 8, "Beth'tilac", 250, "800")
		FIZ_AddMob(1204, 4, 8, "Lord Rhyolith", 250, "800")
		FIZ_AddMob(1204, 4, 8, "Shannox", 250, "800")
		FIZ_AddMob(1204, 4, 8, "Majordomo Staghelm", 400, "800")
